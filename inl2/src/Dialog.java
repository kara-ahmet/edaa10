...
public class Dialog {
	 ...
	 * heltal som returneras. Om användaren anger ett felaktigt värde eller
	 * klickar på "avbryt" så returneras Integer.MAX_VALUE.
	 */
	 ...
	 * teckensträng som returneras. Om användaren klickar på "avbryt" så
	 * returneras null.
	 */
